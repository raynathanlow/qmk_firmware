...
[_RAISE] = LAYOUT_planck_grid(
    ...
    KC_ESC,  _______, _______, KC_0,    KC_DOLLAR, _______,       KC_MUTE, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______,
    KC_LSFT, _______, _______, _______, _______,   _______,       KC_MRWD, KC_VOLD, KC_VOLU, KC_MFFD,  KC_MPLY, _______,
    _______, _______, _______, _______, KC_LCTL,   OSM(MOD_RCTL), _______, _______, _______, _______,  _______, _______
),
...
[_ONESHOT] = LAYOUT_planck_grid(
    ...
    KC_CAPS, _______, SCREENSHOT, KC_END,  KC_HOME, ALTF4, KC_TAPP, KC_TAPU, KC_TAPD, _______, _______, _______,
...
[_GAME] = LAYOUT_planck_grid(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, KC_N,    KC_M,   KC_COMM, KC_DOT,  KC_SLSH, MT(MOD_RSFT, KC_ENT),
    KC_LCTL, KC_4,    KC_3,    KC_2,    KC_SPC,  KC_1, KC_LBRC, KC_RBRC,_______, _______, _______, _______
),
